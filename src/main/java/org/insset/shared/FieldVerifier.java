...
public class FieldVerifier {
    ...
    public static boolean isValidDiviseur(String nbr){
    ...
    public static boolean isValidDividende(String nbr){
    ...
    public static boolean isValidMontantDepart(String nbr){
